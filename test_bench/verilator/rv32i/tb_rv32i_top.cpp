        ...
        while (!file.eof()) {
            ...
            if (file.gcount() == sizeof(value)) {
                if(i < 0x2000){
                    ...
                    dut->rv32i_top->ram0->inner_ram0[i/4] = (uint8_t)(value & 0xff);
                    dut->rv32i_top->ram0->inner_ram1[i/4] = (uint8_t)((value & 0xff00) >> 8);
                    dut->rv32i_top->ram0->inner_ram2[i/4] = (uint8_t)((value & 0xff0000) >> 16);
                    dut->rv32i_top->ram0->inner_ram3[i/4] = (uint8_t)((value & 0xff000000) >> 24);
                }
            }
            i += 4;
        }
