...
//    std::cout << "instr = " << std::bitset<32>(instr) << std::endl;
    ...
    ASSERT_EQ(dut->alu_input1_type, Vrv32i_decoder_rv32i::alu_input_type_e::ALU_INPUT_IMM);
    ASSERT_EQ(dut->alu_input2_type, Vrv32i_decoder_rv32i::alu_input_type_e::ALU_INPUT_NONE);
...
TEST_F(DecoderTest, AUIPC) {
    ...
    ASSERT_EQ(dut->rd, rd);
    ASSERT_EQ(dut->imm, imm);
    ASSERT_EQ(dut->alu_input1_type, Vrv32i_decoder_rv32i::alu_input_type_e::ALU_INPUT_PC);
    ASSERT_EQ(dut->alu_input2_type, Vrv32i_decoder_rv32i::alu_input_type_e::ALU_INPUT_IMM);
    ASSERT_EQ(dut->wb_from, Vrv32i_decoder_rv32i::wb_from_e::WB_ALU);
    ASSERT_EQ(dut->r_we, Vrv32i_decoder_rv32i::reg_we_e::REG_WE);
    ASSERT_EQ(dut->mem_op, Vrv32i_decoder_rv32i::mem_op_e::MEM_LOAD);
    ASSERT_EQ(dut->alu_op, Vrv32i_decoder_rv32i::alu_op_e::ALU_ADD);
...
TEST_F(DecoderTest, JALR) {
    ...
    ASSERT_EQ(dut->rd, rd);
    ASSERT_EQ(dut->imm, imm);
    ASSERT_EQ(dut->alu_input1_type, Vrv32i_decoder_rv32i::alu_input_type_e::ALU_INPUT_REG);
    ASSERT_EQ(dut->alu_input2_type, Vrv32i_decoder_rv32i::alu_input_type_e::ALU_INPUT_IMM);
    ASSERT_EQ(dut->wb_from, Vrv32i_decoder_rv32i::wb_from_e::WB_PC);
    ASSERT_EQ(dut->r_we, Vrv32i_decoder_rv32i::reg_we_e::REG_WE);
    ASSERT_EQ(dut->mem_op, Vrv32i_decoder_rv32i::mem_op_e::MEM_LOAD);
...
TEST_F(DecoderTest, BRANCH) {
    ...
    for(int i = 0; i < length; i++){
        ...
        ASSERT_EQ(dut->imm, imm);
        ASSERT_EQ(dut->alu_input1_type, Vrv32i_decoder_rv32i::alu_input_type_e::ALU_INPUT_REG);
        ASSERT_EQ(dut->alu_input2_type, Vrv32i_decoder_rv32i::alu_input_type_e::ALU_INPUT_REG);
